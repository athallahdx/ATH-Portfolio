...
class PortfolioTypeResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Portfolio Type';

    protected static ?string $pluralModelLabel = 'Portfolio Types';

    protected static ?int $navigationSort = 5;

    protected static ?string $modelLabel = 'Portfolio Type';
